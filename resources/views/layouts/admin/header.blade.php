                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu">
                        ...
                        <li class="has-submenu">
                            <a href="{{ route('admin.index') }}"><i class="icon-accelerator"></i> Dashboard</a>
                        </li>

                        <li class="has-submenu">
                            <a href="{{ route('blogs.index') }}"><i class="icon-accelerator"></i> Bài viết</a>
                        </li>
                        ...
                        <li class="has-submenu">
                            <a href="#"><i class="icon-life-buoy"></i> Components <i
                                    class="mdi mdi-chevron-down mdi-drop"></i></a>
                            <ul class="submenu">
                                <li class="has-submenu">
                                    <a href="#">Email</a>
